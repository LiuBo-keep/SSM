...
<div id="toolbar">
    ...
    <div>
        ...
        年级名：<input id="search-name" class="easyui-textbox" name="name"/>
    ...
    <form id="addForm" method="post">
        <table id="addTable" cellpadding="8">
            <tr>
                <td>年级名:</td>
                <td>
                    <input id="add_name" class="easyui-textbox" style="width: 200px; height: 30px;" type="text"
                           name="name" data-options="required:true, validType:'repeat', missingMessage:'请填写年级名'"/>
                </td>
            </tr>
            <tr>
                <td>备注:</td>
                <td><input id="add_remark" style="width: 256px; height: 180px;" class="easyui-textbox" type="text"
